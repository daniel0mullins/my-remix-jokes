import { ActionFunction, json, LoaderFunction, useActionData, useCatch, Form, useTransition } from "remix";
...
export const action: ActionFunction = async ({
  ...
  const joke = await db.joke.create({ data: { ...fields, jokesterId: userId as string } });
