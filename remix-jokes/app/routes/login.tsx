...
import { Link, useActionData, json, useSearchParams, Form } from "remix";
...
export const action: ActionFunction = async ({ request }) => {
    ...
    switch (loginType) {
        case "login":
            ...
            return createUserSession(loginUser.id, redirectTo);
        case "register":
            ...
            return createUserSession(registerUser.id, redirectTo);
        default:
            return badRequest({
                fields,
        ...
        <Form method="post">
          ...
          <div>
            ...
            {actionData?.fieldErrors?.password ? (
                <p className="form-validation-error" role="alert" id="password-errorr">
                    {actionData.fieldErrors.password}
                </p>
            ): null}
          </div>
